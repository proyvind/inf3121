...
\begin{description}
  ...
  \end{description}
  \item[\req{2}] Select products
  \item[\req{3}] Continue shopping
  \item[\req{4}] Checkout
  \item[\req{5}] Change number of items
  \item[\req{6}] Finalize order succesfully
  \item[\req{7}] Log out
\end{description}
...
\begin{enumerate}
	\item\spec{1} Sign-in \meetsreq{1}
		\begin{table}[ht]
			\centering
		...
		\newpage
		\begin{enumerate}
	\item\spec{2} Register new customer \meetsreq{1.1}
		\begin{table}[ht]
			\centering
		...
		\end{tabular}
	\end{table}
\item\spec{3} Login \meetsreq{1.2}
	\begin{table}[ht]
		\centering
...
\end{table}
\newpage
	\item\spec{4} Password reset \meetsreq{1.3}
		\begin{table}[ht]
			\centering
	...
	\end{table}
\end{enumerate}
\item\spec{5} Selecting products \meetsreq{2}
	\begin{table}[ht]
		\centering
	...
	\end{table}
	\newpage
\item\spec{6} Continue shopping \meetsreq{3} \\
	...
	\begin{table}[ht]
		...
		\end{tabular}
	\end{table}
\item\spec{7} Checkout \meetsreq{4}
	\begin{table}[ht]
		\centering
...
\end{table}
\newpage
	\item\spec{7} Change number of items \meetsreq{5}
		\begin{table}[ht]
			\centering
			...
			\end{tabular}
		\end{table}
	\item\spec{8} Finalize order successfully \meetsreq{6}
		\begin{table}[ht]
			\centering
			...
			\end{tabular}
		\end{table}
	\item\spec{9} Log out \meetsreq{7}
		\begin{table}[ht]
			\centering
