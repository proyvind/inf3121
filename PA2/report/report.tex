...
\begin{center}
	\begin{table}[!htbp]
		...
		\begin{tabular}{| l | l | l | l | l | l |}
			...
			\textbf{Detailed Description:} & \multicolumn{5}{p{13cm}|}{Not specifying an email address when trying to register an account will result in an internal server error.} \\ \hline
			\textbf{Expected result:} & \multicolumn{5}{p{13cm} |}{An informative error message from the page about email address missing.} \\ \hline
