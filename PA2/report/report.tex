...
\subsubsection{1. Register customer, login, password reset}

\begin{table}[ht]
\centering
\caption{Decision table for login/create user}
...
\begin{table}[ht]
\centering
\caption{Use case for register/login user}
...
5a	&	\begin{tabular}[c]{@{}l@{}}Username/email address invalid/missing \\ S:Display error message without proceeding	\end{tabular}	\\ \cline{2-3} &
5b	&	\begin{tabular}[c]{@{}l@{}}Password missing or mismatch \\ S:Display error message without proceeding	\end{tabular}	\\ \cline{2-3}
\hline
\end{tabular}
\end{table}
